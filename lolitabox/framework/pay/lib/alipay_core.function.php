...
function logResult($word='') {
	$logdir=PAY_LOG_DIR_ROOT.DIRECTORY_SEPARATOR.date("Y").DIRECTORY_SEPARATOR.date("m").DIRECTORY_SEPARATOR;
	if(dir_create($logdir)){
		...
		file_put_contents("error.txt",$logdir."--create fail!");
	}
