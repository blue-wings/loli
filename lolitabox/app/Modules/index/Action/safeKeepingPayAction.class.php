<?php
class safeKeepingPayAction extends commonAction {
	/**
     +----------------------------------------------------------
	...
	/**
	 * 支付宝页面跳转同步通知页面
	 * sageKeepingPay/alipay_return?out_trade_no=20140805223007401&trade_no=1&total_fee=2.0&notify_time=2014-08-08&trade_status=TRADE_FINISHED
	 */
	public function alipay_return(){
		...
		if($verify_result) {//验证成功
			...
			if($_GET['trade_status'] == 'TRADE_FINISHED' || $_GET['trade_status'] == 'TRADE_SUCCESS') {
				$order = D("UserSelfPackageOrder")->getOrderInfo($out_trade_no);
